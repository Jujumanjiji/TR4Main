...
enum CARRIED_TYPES
{
    ...
    CR_AMMO2 = 0x10,
    CR_AMMO3 = 0x20,
    CR_AMMOMASK = (CR_AMMO1 | CR_AMMO2 | CR_AMMO3),
};
...
enum SP_FLAGS
{
    ...
    SPF_WIND = 0x100,
    SPF_EXPDEF = 0x200,
    SPF_USEFXOBJPOS = 0x400,
    SPF_UNDERWEXP = 0x800,
    SPF_NODEATTACH = 0x1000,
    SPF_PLASMAEXP = 0x2000,
};
...
enum GF_LEVEL_FLAGS
{
    ...
    SLEV_ALL = (SLEV_YOUNG_LARA|SLEV_WEATHER|SLEV_HORIZON|SLEV_LAYER1|SLEV_LAYER2|SLEV_STAR_FIELD|SLEV_LIGHTNING|SLEV_TRAIN|SLEV_PULSE|SLEV_COL_ADD_HORIZON|SLEV_RESET_HUB|SLEV_LENS_FLARE|SLEV_TIMER|SLEV_MIRROR|SLEV_REMOVE_AMULET|SLEV_NO_LEVEL)
};

enum GF_LANGUAGE_TYPES
{
    LNG_ENGLISH,
    LNG_FRENCH,
    LNG_GERMAN,
...
enum GAMEFLOW_COMMANDS
{
    ...
    GF_KEY_ITEM8_COMBO1,
    GF_KEY_ITEM8_COMBO2,
    GF_PUZZLE_ITEM1_COMBO1,
    GF_PUZZLE_ITEM1_COMBO2,
    GF_PUZZLE_ITEM2_COMBO1,
    GF_PUZZLE_ITEM2_COMBO2,
    GF_PUZZLE_ITEM3_COMBO1,
    GF_PUZZLE_ITEM3_COMBO2,
    GF_PUZZLE_ITEM4_COMBO1,
    GF_PUZZLE_ITEM4_COMBO2,
    GF_PUZZLE_ITEM5_COMBO1,
    GF_PUZZLE_ITEM5_COMBO2,
    GF_PUZZLE_ITEM6_COMBO1,
    GF_PUZZLE_ITEM6_COMBO2,
    GF_PUZZLE_ITEM7_COMBO1,
    GF_PUZZLE_ITEM7_COMBO2,
    GF_PUZZLE_ITEM8_COMBO1,
    GF_PUZZLE_ITEM8_COMBO2,
    GF_PICKUP_ITEM1_COMBO1,
    GF_PICKUP_ITEM1_COMBO2,
    GF_PICKUP_ITEM2_COMBO1,
    GF_PICKUP_ITEM2_COMBO2,
    GF_PICKUP_ITEM3_COMBO1,
    GF_PICKUP_ITEM3_COMBO2,
    GF_PICKUP_ITEM4_COMBO1,
    GF_PICKUP_ITEM4_COMBO2,
    GF_GIVE_ITEM_AT_STARTUP,
    GF_LOSE_ITEM_AT_STARTUP
};
