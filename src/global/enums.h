...
enum SOUND_EFFECT_ID
{
    ...
    DEMIGODS_FEET,
    DEMIGODS_BULL_SNORT,
    DEMIGODS_BULL_HAMMER,
    DEMIGODS_S_WAVE_RUMB,
    DEMIGODS_WEAP_SWOOSH,
    DEMIGODS_FALCON_SQUEAL,
    DEMIGODS_FALCON_PLAS,
    DEMIGODS_RISE,
    DEMI_TUT_PLASMA_SPRAY,
    DEMI_SIREN_SWAVE,
    DEMIGODS_TUT_GROWL,
    JOBY_ELECTRIC_INSERT,
    BAD_LAND,
    DOOR_GEN_THUD,
    BAD_GRUNTS,
    BAD_DIE,
    ...
    OBJ_GEM_SMASH,
    CATBLADES_DRAW,
    SWIRLY_LONG_MOVE_SFX,
    FOOTSTEPS_MUD,
    HORSEMAN_HORSE_NEIGH,
    FOOTSTEPS_GRAVEL,
    FOOTSTEPS_SAND_AND_GRASS,
    FOOTSTEPS_WOOD,
    FOOTSTEPS_MARBLE,
    FOOTSTEPS_METAL,
    GEN_SPHINX_DOORTHD,
