...
#define DoRayBox ((BOOL(__cdecl*)(GAME_VECTOR *start, GAME_VECTOR *end, short *box, PHD_3DPOS *itemorstatic_pos, PHD_VECTOR *hitpos, short close_item_number)) 0x0044CDF0)
